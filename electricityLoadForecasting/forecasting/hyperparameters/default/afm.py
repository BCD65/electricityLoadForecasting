                ...
                ('eCO2mix.France',
                 None,
                      ...
                      'univariate': pd.DataFrame([
                                                  # Univariate features
                                                  ('B', ('daylight',      '',           ''),                           'p1',    'ridge',         1e-8, None),
                                                  ('B', ('holidays',      '',           ''),                           'p1',    'ridge',         1e-8, None),
                                                  ('B', ('holidays',      'lag',        pd.DateOffset(hours = 24)),    'p1',    'ridge',         1e-8, None),
                                                  ('B', ('holidays',      'lag',      - pd.DateOffset(hours = 24)),    'p1',    'ridge',         1e-8, None),
                                                  ('B', ('nebulosity',    '',           ''),                           'p1',    'ridge',         1e-8, None),
                                                  ...
                                                  ('B', ('temperature',   'minimum',    pd.DateOffset(hours = 24)),     16,     'smoothing_reg', 1e-1, None),
                                                  ('B', ('timestamp',     '',           ''),                           'p1',    'ridge',         1e-3, None),
                                                  ('B', ('week_hour',     '',           ''),                            168,    'ridge',         1e-8, None),
                                                  ('B', ('xmas',          '',           ''),                           'p1',    '',              1e-8, None),
                                                  ('B', ('year_day',      '',           ''),                            128,    'smoothing_reg', 1e-3, None),
                                              ],
                                             columns = ['coefficient',
                                                        'input',
                                                        'nb_intervals',
                      ...
                      'sesq': pd.DataFrame([
                                                  ...
                                                  ('Cb', ('target',        'lag',        pd.DateOffset(hours = 24)),     'p1',     'smoothing_reg',  1e-4, None),
                                                  ('Cb', ('week_hour',     '',           ''),                            168,      'ridge',   1e-8, None),
                                                  ('Cb', ('year_day',      '',           ''),                            128,      'smoothing_reg',  1e-3, None),
                ...
                ('RTE.substations',
                 None,
                      ...
                      'univariate': pd.DataFrame([
                                                  ...
                                                  ('B', ('holidays',      'lag',      - pd.DateOffset(hours = 24)),    'p1',    'ridge',         1e-8, None),
                                                  ('B', ('nebulosity',    '',           ''),                           'p1',    'ridge',         1e-8, None),
                                                  ('B', ('target',        'lag',        pd.DateOffset(hours = 24)),     2,      'smoothing_reg', 1e-4, None),
                                                  ('B', ('temperature',   '',           ''),                            8,      'smoothing_reg', 1e-3, None),
                                                  ('B', ('temperature',   'lag',        pd.DateOffset(hours = 24)),     8,      'smoothing_reg', 1e-5, None),
                                                  ('B', ('temperature',   'maximum',    pd.DateOffset(hours = 24)),     8,      'smoothing_reg', 1e-3, None),
                                                  ('B', ('temperature',   'minimum',    pd.DateOffset(hours = 24)),     8,      'smoothing_reg', 1e-2, None),
                                                  ('B', ('timestamp',     '',           ''),                           'p1',    'ridge',         1e-2, None),
                                                  ('B', ('week_hour',     '',           ''),                            168,    'ridge',         1e-5, None),
                                                  ('B', ('xmas',          '',           ''),                           'p1',    '',              1e-8, None),
                                                  ('B', ('year_day',      '',           ''),                            16,     'smoothing_reg', 1e2,  None),
                                              ],
                                             columns = ['coefficient',
                                                        'input',
                                                        'nb_intervals',
                      ...
                      'sesq': pd.DataFrame([
                                                  ...
                                                  ('B', (('temperature',  '',           ''),
                                                         ('year_day',     '',           '')),                          (8, 16),    'smoothing_reg', 1e2,  None),
                                                  # Univariate linked features
                                                  ('Cb', ('target',        'lag',        pd.DateOffset(hours = 24)),     2,        'smoothing_reg', 1e-4, None),
                                                  ('Cb', ('week_hour',     '',           ''),                            168,      'ridge',         1e-5, None),
                                                  ('Cb', ('year_day',      '',           ''),                            16,       'smoothing_reg', 1e2,  None),
                                                  # Bivariate linked features
                                                  ('Cbm', (('target',       'lag',       pd.DateOffset(hours = 24)),
                      ...
                      'low_rank': pd.DataFrame([
                                                  ...
                                                  ('Blr', ('week_hour',     '',           ''),                         168,       'ridge',                1e-5, None),
                                                  ('Blr', ('year_day',      '',           ''),                         16,        'factor_smoothing_reg', 1e2,  None),
                      ...
                      'block_smoothing_reg': pd.DataFrame([
                                                  # Univariate features
                                                  ('B', ('target',        'lag',        pd.DateOffset(hours = 24)),     2,         'block_smoothing_reg', (1e-4*factor_nb_posts, 1.1), None),
                                                  ('B', ('temperature',   '',           ''),                            8,         'block_smoothing_reg', (1e-4*factor_nb_posts, 1.1), None),
                                                  ('B', ('temperature',   'lag',        pd.DateOffset(hours = 24)),     8,         'block_smoothing_reg', (1e-4*factor_nb_posts, 1.1), None),
                                                  ('B', ('temperature',   'maximum',    pd.DateOffset(hours = 24)),     8,         'block_smoothing_reg', (1e-4*factor_nb_posts, 1.1), None),
                                                  ('B', ('temperature',   'minimum',    pd.DateOffset(hours = 24)),     8,         'block_smoothing_reg', (1e-4*factor_nb_posts, 1.1), None),
                                                  ('B', ('timestamp',     '',           ''),                            'p1',      'ridge',                1e-3,                       None),
                                                  ('B', ('week_hour',     '',           ''),                            168,       'ridge',                1e-8,                       None),
                                                  ('B', ('xmas',          '',           ''),                            'p1',      '',                     1e-8,                       None),
                                                  ('B', ('year_day',      '',           ''),                            16,        'block_smoothing_reg',  1e-3,                       None),
                                                  # Bivariate features
                                                  ('B', (('daylight',     '',           ''),
